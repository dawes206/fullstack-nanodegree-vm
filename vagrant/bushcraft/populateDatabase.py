...
from database_setup import Base, Items, User #, Pack
...
#Items
item1 = Items(name="knife", description = "Simple knife for processing game", weight = "5", volume = "0.2", packed = True, user_id = "0")
item2 = Items(name="thick sleeping bag", description = "Suitable for -20 F", weight = "24", volume = "5", packed = True, user_id = "0")
item3 = Items(name="tent", description = "Cheapest I could find with 4 walls", weight = "32", volume = "8", packed = True, user_id = "0")
item4 = Items(name="snow shoes", description = "DIY tennis racket shoes", weight = "16", volume = "0", packed = False, user_id = "0")
...
#Items
item1 = Items(name="knife", description = "Simple knife for processing game", weight = "5", volume = "0.2", category = "cutting", packed = True, user_id = "1")
item2 = Items(name="sleeping bag", description = "Suitable for 50 F", weight = "16", volume = "4", category = "shelter", packed = True, user_id = "1")
item3 = Items(name="tent", description = "Cheapest I could find with 4 walls", weight = "32", volume = "8", category = "shelter", packed = True, user_id = "1")
item4 = Items(name="snow shoes", description = "DIY tennis racket shoes", weight = "16", volume = "0", category = "shelter", packed = False, user_id = "1")
item5 = Items(name = "compass", description = "compass", weight = "5", volume = "0.2", category = "navigation", packed = True, user_id = "1")
item6 = Items(name = "pot", description = "2 L pot", weight = "8", volume = "2", category = "container", packed = True, user_id = "1")
item7 = Items(name = "parachord", description = "50 ft", weight = "12", volume = ".5", category = "cordage", packed = True, user_id = "1")
